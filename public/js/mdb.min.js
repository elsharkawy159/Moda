            ...
            return [
              ...
              function (t, e) {
                ...
                for (
                  ...
                  null !== (d = I(n, i)) && (M(a, d), s);

                )
                  "" === O(d[0]) && (n.lastIndex = L(i, T(n.lastIndex), o));
      ...
      function (N, t, e) {
        ...
        class Xe extends g {
          ...
          _initEvents() {
            this._supportPointerEvents
              ...
              : (f.on(this._element, Fe, (t) => this._start(t)),
        ...
        class pn extends m {
          ...
          _maybeEnableCycle() {
            this._config.ride &&
              (this._isSliding
                ? f.one(this._element, en, () => this.cycle())
                : this.cycle());
          }
          to(t) {
            var e,
            ...
            t > n.length - 1 ||
              t < 0 ||
              (this._isSliding
                ? f.one(this._element, en, () => this.to(t))
                : (e = this._getItemIndex(this._getActive())) !== t &&
                  ((e = e < t ? $e : Ge), this._slide(e, n[t])));
          }
          dispose() {
          ...
          _addEventListeners() {
            this._config.keyboard &&
              f.on(this._element, nn, (t) => this._keydown(t)),
              "hover" === this._config.pause &&
                (f.on(this._element, on, () => this.pause()),
                f.on(this._element, rn, () => this._maybeEnableCycle())),
              this._config.touch &&
                Ke.isSupported() &&
          ...
          _setActiveIndicatorElement(t) {
            ...
            this._indicatorsElement &&
              ((e = y.findOne(ln, this._indicatorsElement)).classList.remove(
                cn
              ),
        ...
        class Dn extends m {
          ...
          show(t) {
            this._isShown ||
              ...
              f.trigger(this._element, En, { relatedTarget: t })
                .defaultPrevented ||
              ((this._isShown = !0),
            ...
            this._queueCallback(
              () => {
                this._config.focus && this._focustrap.activate(),
                  (this._isTransitioning = !1),
                  f.trigger(this._element, xn, { relatedTarget: t });
              },
              this._dialog,
              this._isAnimated()
            );
        ...
        function hi(t, e, n) {
          ...
          e &&
            T(t) &&
            ((o = (0 < t.offsetWidth && ci(i.width) / t.offsetWidth) || 1),
            (r = (0 < t.offsetHeight && ci(i.height) / t.offsetHeight) || 1));
        ...
        function Bi(t, e, n) {
          return e === qn
            ...
            : Hi(
                ...
                (a = -a.scrollTop),
                "rtl" === D(l || c).direction &&
                  (s += si(c.clientWidth, l ? l.clientWidth : 0) - i),
        ...
        function qi(t, e) {
          var i,
            ...
            c = Wi(
              ii(c) ? c : c.contextElement || pi(t.elements.popper),
              r,
              s,
              o
            ),
                    ...
                    return t.concat(
                      k(e) === Rn
                        ? ((n = h),
                          ...
                          (a = t.flipVariations),
                          (c =
                            void 0 === (t = t.allowedAutoPlacements) ? Un : t),
                          (l = Ci(i)),
                          (t = l
                            ? a
                              ? Vn
            ...
            w &&
              (d &&
                ...
                (o = m
                  ...
                  : _ + l + i + h.mainAxis),
                (m = (n = u.elements.arrow && _i(u.elements.arrow))
                  ? "y" === b
                    ? n.clientTop || 0
                    : n.clientLeft || 0
                  : 0),
        ...
        function $i(t, e, n) {
          ...
          var i = T(e),
            o =
              ...
              (r = ci(s.width) / o.offsetWidth || 1),
              (s = ci(s.height) / o.offsetHeight || 1),
              1 !== r || 1 !== s),
            r = pi(e),
            s = hi(t, o, n),
              ...
              (("body" === C(e) && !Ni(r)) ||
                (t =
                  (i = e) !== A(i) && T(i)
                    ...
                    : Mi(i)),
              T(e)
                ? (((a = hi(e, !0)).x += e.clientLeft), (a.y += e.clientTop))
                : r && (a.x = Pi(r))),
            {
            ...
            if (Object.keys(e).includes(i)) {
              ...
              for (const a of o)
                ((t, e) => {
                  ...
                  return e.includes(n)
                    ? !oo.has(n) ||
                        Boolean(ro.test(t.nodeValue) || so.test(t.nodeValue))
                    : e
        ...
        var ho = class extends g {
          ...
          _checkContent(t) {
            for (var [e, n] of Object.entries(t))
              super._typeCheckConfig({ selector: e, entry: n }, uo);
          }
          _setContent(t, e, n) {
            n = y.findOne(n, t);
            n &&
          ...
          _maybeSanitize(t) {
            return this._config.sanitize
              ? ao(t, this._config.allowList, this._config.sanitizeFn)
              : t;
          }
        ...
        class xo extends m {
          ...
          hide() {
            if (this._isShown()) {
              ...
              if (!t.defaultPrevented) {
                if (
                  (this._getTipElement().classList.remove(go),
                  "ontouchstart" in document.documentElement)
                )
              ...
              "click" === n
                ...
                : "manual" !== n &&
                  ...
                  f.on(this._element, t, this._config.selector, (t) => {
                    ...
                    (e._activeTrigger["focusin" === t.type ? bo : vo] = !0),
                      e._enter();
                  }),
                  f.on(this._element, e, this._config.selector, (t) => {
                    var e = this._initializeOnDelegatedTarget(t);
                    (e._activeTrigger["focusout" === t.type ? bo : vo] =
        ...
        a.find('[data-mdb-toggle="popover"]').forEach((t) => {
          ...
          o(() => {
            ...
            if (t) {
              const e = t.fn[Oo];
              (t.fn[Oo] = So.jQueryInterface),
                (t.fn[Oo].Constructor = So),
                (t.fn[Oo].noConflict = () => (
                  (t.fn[Oo] = e), So.jQueryInterface
                ));
            }
          });
        var Io = So;
        ...
        class Ho extends m {
          ...
          _initializeTargetsAndObservables() {
            ...
            (this._targetLinks = new Map()),
              (this._observableSections = new Map());
            for (const e of y.find(Mo, this._config.target))
              e.hash &&
                !ft(e) &&
          ...
          _process(t) {
            this._activeTarget !== t &&
              ...
              (this._activeTarget = t).classList.add(jo),
              this._activateParents(t),
              f.trigger(this._element, ko, { relatedTarget: t }));
          }
          _activateParents(t) {
          ...
          _clearActiveClass(t) {
            ...
            for (const e of y.find("".concat(Mo, ".").concat(jo), t))
        ...
        s.on(window, g, () => {
          ...
          o(() => {
            ...
            if (t) {
              const e = t.fn[Bo];
              (t.fn[Bo] = Vo.jQueryInterface),
                (t.fn[Bo].Constructor = Vo),
                (t.fn[Bo].noConflict = () => (
                  (t.fn[Bo] = e), Vo.jQueryInterface
                ));
            }
          });
        var Uo = Vo;
        ...
        const nr = "".concat(E, ", ").concat(g),
          ir = "."
            .concat(tr, '[data-mdb-toggle="tab"], .')
            .concat(tr, '[data-mdb-toggle="pill"], .')
            .concat(tr, '[data-mdb-toggle="list"]');
        class or extends m {
          constructor(t) {
            super(t),
              ...
              this._parent &&
                ...
                f.on(this._element, Go, (t) => this._keydown(t)));
          }
          static get NAME() {
            return "tab";
          }
          show() {
            ...
            this._elemIsActive(n) ||
              ((e = (t = this._getActiveElem())
                ? f.trigger(t, Yo, { relatedTarget: n })
                : null),
              f.trigger(n, Ko, { relatedTarget: t }).defaultPrevented) ||
                ...
                () => {
                  "tab" !== t.getAttribute("role")
                    ...
                    : (t.setAttribute("aria-selected", !1),
                      ...
                      f.trigger(t, Xo, { relatedTarget: e }));
                },
                t,
                t.classList.contains("fade")
              ));
        ...
        f.on(document, _, g, function (t) {
          ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
            ft(this) || or.getOrCreateInstance(this).show();
        }),
          f.on(window, v, () => {
                ...
                () => {
                  "tab" !== t.getAttribute("role")
                    ...
                    : (t.focus(),
                      ...
                      t.setAttribute("aria-selected", !0),
                      this._toggleDropDown(t, !0),
                      s.trigger(t, ar, { relatedTarget: e }),
                      s.trigger(t, lr, { relatedTarget: e }));
                },
                t,
                t.classList.contains("fade")
              ));
                ...
                () => {
                  "tab" !== t.getAttribute("role")
                    ...
                    : (t.setAttribute("aria-selected", !1),
                      ...
                      s.trigger(t, hr, { relatedTarget: e }));
                },
                t,
                t.classList.contains("fade")
              ));
        ...
        a
          ...
          o(() => {
            ...
            if (t) {
              const e = t.fn.tab;
              (t.fn.tab = dr.jQueryInterface),
                (t.fn.tab.Constructor = dr),
                (t.fn.tab.noConflict = () => (
                  (t.fn.tab = e), dr.jQueryInterface
                ));
            }
          });
        var fr = dr;
        ...
        a.find('[data-mdb-toggle="tooltip"]').forEach((t) => {
          ...
          o(() => {
            ...
            if (t) {
              const e = t.fn[pr];
              (t.fn[pr] = mr.jQueryInterface),
                (t.fn[pr].Constructor = mr),
                (t.fn[pr].noConflict = () => (
                  (t.fn[pr] = e), mr.jQueryInterface
                ));
            }
          });
        var _r = mr;
              ...
              this._queueCallback(
                () => {
                  this._element.classList.add("hide"),
                    this._element.classList.remove(Or, Tr),
                    f.trigger(this._element, xr);
                },
                this._element,
                this._config.animation
              ));
        ...
        a.find(".toast").forEach((t) => {
          ...
          o(() => {
            ...
            if (t) {
              const e = t.fn[kr];
              (t.fn[kr] = jr.jQueryInterface),
                (t.fn[kr].Constructor = jr),
                (t.fn[kr].noConflict = () => (
                  (t.fn[kr] = e), jr.jQueryInterface
                ));
            }
          });
        var Mr = jr;
        ...
        class j {
          ...
          _getNotchData() {
            (this._notchMiddle = a.findOne(Vr, this._element)),
              (this._notchLeading = a.findOne(Qr, this._element));
          }
          _getLabelWidth() {
          ...
          _getElements(t) {
            ...
            t &&
              ...
              t &&
                ...
                (this._notchLeading = a.findOne(Qr, t.target.parentNode)),
                this._applyNotch());
          }
          _deactivate(t) {
            t = t ? t.target : this.input;
            "" === t.value && t.classList.remove(Rr),
              this._toggleDefaultDatePlaceholder(t);
          }
          static activate(e) {
            return function (t) {
        ...
        s.on(document, "focus", Fr, j.activate(new j())),
          ...
          o(() => {
            ...
            if (t) {
              const e = t.fn[Pr];
              (t.fn[Pr] = j.jQueryInterface),
                (t.fn[Pr].Constructor = j),
                (t.fn[Pr].noConflict = () => (
                  (t.fn[Pr] = e), j.jQueryInterface
                ));
            }
          });
        var Yr = j;
                  ...
                  this._queueCallback(
                    () => {
                      (this._isTransitioning = !1),
                        ...
                        this._element.classList.add(Jr, Zr),
            ...
            if (!this._isTransitioning && this._isShown()) {
              ...
              if (!t.defaultPrevented) {
                ...
                (this._element.style[t] = "".concat(
                  ...
                  mt(this._element),
                  this._element.classList.add(ts),
                  this._element.classList.remove(Jr, Zr);
        ...
        f.on(document, w, ns, function (t) {
          ...
          for (const e of y.find(t))
            rs.getOrCreateInstance(e, { toggle: !1 }).toggle();
        }),
          t(rs);
        v = rs;
        const ss = "collapse",
        ...
        class M extends m {
          constructor(t, e) {
            super(t, e),
              ...
              (this._menu =
                y.next(this._element, bs)[0] ||
                y.prev(this._element, bs)[0] ||
                y.findOne(bs, this._parent)),
          ...
          static dataApiKeydownHandler(t) {
            ...
            (!i && !n) ||
              ...
              (e = this.matches(_s)
                ...
                : y.prev(this, _s)[0] ||
                  y.next(this, _s)[0] ||
                  y.findOne(_s, t.delegateTarget.parentNode)),
        ...
        class qs extends v {
          ...
          _bindShowEvent() {
            s.on(this._element, js, (t) => {
              s.trigger(this._element, Rs, { relatedTarget: t.relatedTarget })
                .defaultPrevented
                ? t.preventDefault()
          ...
          _bindShownEvent() {
            s.on(this._parent, Ms, (t) => {
              s.trigger(this._parent, Hs, { relatedTarget: t.relatedTarget })
                .defaultPrevented && t.preventDefault();
            });
          }
          _bindHideEvent() {
            s.on(this._parent, ks, (t) => {
              s.trigger(this._parent, Ps, { relatedTarget: t.relatedTarget })
                .defaultPrevented
                ? t.preventDefault()
          ...
          _bindHiddenEvent() {
            s.on(this._parent, Ds, (t) => {
              s.trigger(this._parent, Ns, { relatedTarget: t.relatedTarget })
                .defaultPrevented
                ? t.preventDefault()
                : ("static" !== this._config.display &&
                    "" !== this._menuStyle &&
          ...
          _dropdownAnimationStart(t) {
            "show" === t
              ? (this._menu.classList.add(Bs, Ws),
                this._menu.classList.remove(Fs))
              : (this._menu.classList.add(Bs, Fs),
        ...
        class ta {
          constructor(t, e) {
            (this._element = t),
              ...
              this._element &&
                (r.setData(t, Vs, this), c.addClass(this._element, P)),
              ...
              (this._rippleTimer = setTimeout(() => {
                e &&
                  ...
                  this._isMinWidthSet &&
                    ...
                    (this._isMinWidthSet = !1)),
                  this._rippleInSpan && this._element.classList.contains(Ys)
        ...
        class aa {
          constructor(t) {
            (this._element = t),
              (this._initiated = !1),
              (this._thumb = null),
              this._element && (r.setData(t, ia, this), this.init());
          }
          static get NAME() {
            return na;
          }
          ...
          _addThumb() {
            var t = F("span");
            c.addClass(t, "thumb"),
              (t.innerHTML = '<span className="thumb-value"></span>'),
          ...
          _thumbUpdate() {
            var t = this.rangeInput,
              ...
              t = t.max || 100,
              e =
                ((a.findOne(ra, this._thumb).textContent = e),
                Number((100 * (e - n)) / (t - n)));
            c.style(this._thumb, {
          ...
          static jQueryInterface(n, i) {
            return this.each(function () {
              ...
              if (
                (t || !/dispose/.test(n)) &&
                ((t = t || new aa(this, e)), "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "'.concat(n, '"'));
                t[n](i);
